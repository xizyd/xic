...
// 3. Desktop OS (Fedora / Windows)
        ...
        {
            i64 m = micros();
            i64 currentEpoch = m + systemStartMicros;
            i64 nearestSecondMicros = ((currentEpoch + 500000ULL) / 1000000ULL) * 1000000ULL;
            systemStartMicros = nearestSecondMicros - m;
        }

        static void syncClock(i64 now)
        {
            i64 uptimeMicros = micros();
